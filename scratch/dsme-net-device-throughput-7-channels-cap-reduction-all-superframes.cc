...
int main(int argc, char** argv) {
    ...
    // superframeID = 0
    for (unsigned j = 0; j < numOfChannelsSupported; j++) {
        for (int i = 0; i < 7; ++i) {
            int childIdx = i + 8 + j * 15; 

            lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(j + 1)->GetObject<LrWpanNetDevice>(), true, 1, channelOffsets[j]
                                    , 0, i);

            lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(childIdx)->GetObject<LrWpanNetDevice>(), false, 1, channelOffsets[j]
                                    , 0, i);
        }
    }

    for (uint16_t superframeID = 1; superframeID <= 7; ++superframeID) {
        for (int i = 0; i < 15; ++i) {
            int childIdx = i + 8;
    ...
    for (int i = 0; i < 15; ++i) {
        int childIdx = i + 38;
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(3)->GetAddress(), 60,  251.65824, 100000.0, 7.86432);
    }
    ...
    for (int i = 0; i < 15; ++i) {
        int childIdx = i + 53;
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(4)->GetAddress(), 60,  251.65824, 100000.0, 7.86432);
    }
    ...
    for (int i = 0; i < 15; ++i) {
        int childIdx = i + 68;
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(5)->GetAddress(), 60,  251.65824, 100000.0, 7.86432);
    }
    ...
    for (int i = 0; i < 15; ++i) {
        int childIdx = i + 83;
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(6)->GetAddress(), 60,  251.65824, 100000.0, 7.86432);
    }
    ...
    for (int i = 0; i < 15; ++i) {
        int childIdx = i + 98;
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(7)->GetAddress(), 60,  251.65824, 100000.0, 7.86432);
    }
