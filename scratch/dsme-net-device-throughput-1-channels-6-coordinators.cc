...
int main(int argc, char** argv) {
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(3)->GetObject<LrWpanNetDevice>(), true, 1, channelOffsets[0]
                                , 2, i);
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(4)->GetObject<LrWpanNetDevice>(), true, 1, channelOffsets[0]
                                , 3, i);
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(5)->GetObject<LrWpanNetDevice>(), true, 1, channelOffsets[0]
                                , 4, i);
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(6)->GetObject<LrWpanNetDevice>(), true, 1, channelOffsets[0]
                                , 5, i);
