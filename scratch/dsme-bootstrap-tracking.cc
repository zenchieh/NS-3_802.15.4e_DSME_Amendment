...
int main(int argc, char* argv[]) {
    ...
    lrWpanHelper.EnablePcap(std::string("dsme-bootstrap-tracking-coordNetDevice.pcap"), coordNetDevice, true, true);
    lrWpanHelper.EnablePcap(std::string("dsme-bootstrap-tracking-endNodeNetDevice.pcap"), endNodeNetDevice, true, true);
