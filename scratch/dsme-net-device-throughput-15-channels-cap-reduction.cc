...
int main(int argc, char** argv) {
    ...
    for (int j = 0; j < numOfChannelsSupported; ++j) {
        for (int i = 0; i < 15; ++i) {
            ...
            // lrWpanHelper.AddGtsInCfp(lrwpanDevices.Get(j + 1)->GetObject<LrWpanNetDevice>(), true, 1, superframeID, i);
            ...
            lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(j + 1)->GetAddress(), pktSize, 200, 100000.0, 125.8295);
        }
    }
