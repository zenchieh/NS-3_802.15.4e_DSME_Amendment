...
int main(int argc, char** argv) {
    ...
    uint16_t numOfChannelsSupported = 5;
    ...
    for (int i = 0; i < 15; ++i) {
        ...
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(1)->GetAddress(), pktSize, 300, 100000.0, 125.8295);
    }
    ...
    for (int i = 0; i < 15; ++i) {
        ...
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(2)->GetAddress(), pktSize, 300, 100000.0, 125.8295);
    }
    ...
    for (int i = 0; i < 15; ++i) {
        ...
        lrWpanHelper.GenerateTraffic(lrwpanDevices.Get(childIdx), lrwpanDevices.Get(3)->GetAddress(), pktSize, 300, 100000.0, 125.8295);
    }
