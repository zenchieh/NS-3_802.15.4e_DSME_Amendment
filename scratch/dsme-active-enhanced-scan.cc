...
int main(int argc, char* argv[]) {
    ...
    lrWpanHelper.EnablePcap(std::string("dsme-active-enhanced-scan-coord1NetDevice.pcap"), coord1NetDevice, true, true);
    lrWpanHelper.EnablePcap(std::string("dsme-active-enhanced-scan-endNodeNetDevice.pcap"), endNodeNetDevice, true, true);
    lrWpanHelper.EnablePcap(std::string("dsme-active-enhanced-scan-coord2NetDevice.pcap"), coord2NetDevice, true, true);
