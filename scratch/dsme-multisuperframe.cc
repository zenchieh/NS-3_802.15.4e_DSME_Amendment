...
main(int argc, char* argv[])
{
    ...
    lrWpanHelper.EnablePcap(std::string("dsme-multisuperframe-dev0.pcap"), dev0, true, true);
    lrWpanHelper.EnablePcap(std::string("dsme-multisuperframe-dev1.pcap"), dev1, true, true);
