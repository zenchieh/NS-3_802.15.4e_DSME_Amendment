...
int main(int argc, char* argv[]) {
    ...
    lrWpanHelper.EnablePcap(std::string("dsme-bootstrap-coordNetDevice.pcap"), coordNetDevice, true, true);
    lrWpanHelper.EnablePcap(std::string("dsme-bootstrap-endNodeNetDevice.pcap"), endNodeNetDevice, true, true);
