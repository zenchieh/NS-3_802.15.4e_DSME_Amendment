...
static void AssociateIndication(Ptr<LrWpanNetDevice> device, MlmeAssociateIndicationParams params) {
    ...
    if (params.capabilityInfo.IsShortAddrAllocOn()) {
        ...
        assocRespParams.m_assocShortAddr = Mac16Address("00:09");
...
int main(int argc, char* argv[]) {
    ...
    lrWpanHelper.EnablePcap(std::string("dsme-disassociation-coordNetDevice.pcap"), coordNetDevice, true, true);
    lrWpanHelper.EnablePcap(std::string("dsme-disassociation-endNodeNetDevice.pcap"), endNodeNetDevice, true, true);
    ...
    endNodeNetDevice->GetMac()->SetExtendedAddress(Mac64Address("00:00:00:00:00:00:00:00"));
    ...
    endNodeNetDevice->GetMac()->SetMlmeDisassociateIndicationCallback(MakeBoundCallback(&DisassociateIndication, endNodeNetDevice));
    endNodeNetDevice->GetMac()->SetMlmeDisassociateConfirmCallback(MakeBoundCallback(&DisassociateConfirm, endNodeNetDevice));
    ...
    coordNetDevice->GetMac()->SetExtendedAddress(Mac64Address("00:00:00:00:00:00:00:01"));
    ...
    coordNetDevice->GetMac()->SetMlmeDisassociateIndicationCallback(MakeBoundCallback(&DisassociateIndication, coordNetDevice));
    coordNetDevice->GetMac()->SetMlmeDisassociateConfirmCallback(MakeBoundCallback(&DisassociateConfirm, coordNetDevice));
    ...
    // DSME
    params.m_dsmeSuperframeSpec.SetMultiSuperframeOrder(6);
    ...
    disasscoParams.m_shortDevAddr = Mac16Address("00:09");
    disasscoParams.m_extDevAddr = Mac64Address("00:00:00:00:00:00:00:00");
